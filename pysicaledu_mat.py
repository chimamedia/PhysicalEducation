...
#                            cv2.circle(image, (x, y), 2, Colors[i], -1)
            ...
            cv2.circle(image, points[15], 6, Colors[i], -1)
            cv2.circle(image, points[16], 6, Colors[i], -1)
            cv2.circle(image, points[4], 6, Colors[i], -1)
            cv2.circle(image, points[7], 6, Colors[i], -1)
            cv2.circle(image, points[2], 6, Colors[i], -1)
            cv2.circle(image, points[5], 6, Colors[i], -1)
            #しゃがんでいるか
            if( (abs(points[8][1] - points[9][1]) < 20) and (abs(points[11][1] - points[12][1]) < 20) \
                and (CalcDist(points[0], points[4]) < 40 or CalcDist(points[0], points[7]) < 40) ):
                cv2.putText(image,'Good (Hand Position)',(800,400),font,2,(255,125,0),cv2.LINE_AA)
                cv2.putText(img,'Good (Hand Position)',(800,400),font,2,(255,125,0),cv2.LINE_AA)
            
            #おしりと足が離れているか
            if( (abs(points[8][1] - points[10][1]) < 20) and (abs(points[11][1] - points[13][1]) < 20) \
                and (CalcDist(points[8], points[10]) > 40 or CalcDist(points[8], points[10]) > 30) ):
                cv2.putText(image,'Good (Leg Position)',(800,550),font,2,(200,200,0),cv2.LINE_AA)
                cv2.putText(img,'Good (Leg Position)',(800,550),font,2,(200,200,0),cv2.LINE_AA)
